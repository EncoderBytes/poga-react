...
import DistilationImg from "../../../../assets/chem/chem9/Distilation.png"
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    ...
                    <p className="font-semibold text-base text-dark50 mt-2">
                        Separate the given mixture of alcohol and water by distillation                    </p>
                </div>
