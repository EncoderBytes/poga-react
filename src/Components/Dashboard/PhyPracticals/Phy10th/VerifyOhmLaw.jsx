...
import verifyOhm from "../../../../assets/verifyOhm.png"
  ...
  return (
    <NavLink to='/Dashmain/phypracticals/OhmExp11'>
      <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
        <div className="p-4">
          <img src={verifyOhm} alt="" className='rounded-md' />
          {/* <p className="font-semibold text-base text-dark50 mt-2">Verify Ohm’s law (using wire as a conductor)</p> */}
        </div>
