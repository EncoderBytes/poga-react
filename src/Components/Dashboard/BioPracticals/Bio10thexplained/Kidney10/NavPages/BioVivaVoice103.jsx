...
const BioVivaVoice103 = () => {
    return (
        <div className=" mt-5 pl-3">
            <p className="font-semibold text-dark text-xl my-4">1. Simple Pendulum does not vibrate at.</p>
            <ol className='pl-2 text-dark50 text-base'>
                <li className="option"><label><input type="radio" name="answer1" value="option1" /> South Pole.</label></li>
                <li className="option"><label><input type="radio" name="answer1" value="option2" /> North Pole.</label></li>
            ...
            <ol className='pl-2 text-dark50 text-base'>
                ...
                <li className="option"><label><input type="radio" name="answer6" value="option4" /> None of the above.</label></li>
            </ol>
