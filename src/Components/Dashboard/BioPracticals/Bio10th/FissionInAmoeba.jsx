        ...
        <NavLink to='/Dashmain/biopracticals/FissionInAmoeba10/theory'>
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    ...
                    {/* <p className="font-semibold text-base text-dark50 mt-2">Observation of binary fission in Amoeba by using slides, Photomicrographs, and Charts</p> */}
                </div>
...
export default FissionInAmoeba