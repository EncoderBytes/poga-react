...
import KidneyImg from "../../../../assets/bio/bio10th/3.png"
    ...
    return (
        <NavLink to='/Dashmain/phypracticals/EmfExp'>
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    <img src={KidneyImg} alt="" className='rounded-md' />
                    {/* <p className="font-semibold text-base text-dark50 mt-2">xamination of the structure of the Kidney (Sheep Kidney / Model) </p> */}
                </div>
