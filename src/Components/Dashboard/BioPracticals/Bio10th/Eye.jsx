    ...
    return (
        <NavLink to='/Dashmain/phypracticals/EmfExp'>
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    <img src={EyeImg} alt="" className='rounded-md' />
                    {/* <p className="font-semibold text-base text-dark50 mt-2">SIdentify the different parts and draw a labeled diagram of the longitudinal section of the eye of a sheep or a bull</p> */}
                </div>
