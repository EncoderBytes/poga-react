    ...
    return (
        <NavLink to='/Dashmain/phypracticals/EmfExp'>
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    <img src={PlasmolysisImg} alt="" className='rounded-md' />
                    {/* <p className="font-semibold text-base text-dark50 mt-2">Determination of the effect of tonicity on plasmolysis and de-plasmolysis in plant cells or red blood cells</p> */}
                </div>
