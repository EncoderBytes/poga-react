...
import StudyOfBacteriaImg from "../../../../assets/bio/Bio9th/StudyOfBacteria.png"
import { NavLink } from 'react-router-dom'

const StudyOfBacteria = () => {
    return (
        <NavLink to='/Dashmain/phypracticals/EmfExp'>
            ...
            <div className='w-64 h-64 bg-overviewWhite border-primaryGradient border-2 rounded-xl relative'>
                <div className="p-4">
                    <img src={StudyOfBacteriaImg} alt="" className='rounded-md' />
...
export default StudyOfBacteria